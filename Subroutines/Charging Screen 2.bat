:: First initialize the charging screen, with this parameters :initProgressBar "Fill (Example: #)" "Empty space (Example: " ")"
:: Then execute :drawProgressBar with this parameters :drawProgressBar "100% Value (Example: 5, Another Example: 99)" "Text in the right side of the progress bar (Example: "completed of %initialValue%")"
:: Finally execute :finalizeProgressBar to finalize it
